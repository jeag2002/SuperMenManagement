...
public class JerseySSLClient {
    ...
    private static final String truststore_path = "jks/cacerts.jks";
    private static final String truststore_password = "changeit";
    private static final String keystore_path = "jks/cacerts.jks";
    private static final String keystore_password = "changeit";
    private static final String url = "https://localhost:8443/PayworkExamSSL/rest/superhero";

    public JerseySSLClient() {
